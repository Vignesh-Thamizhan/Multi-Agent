...
export const AGENTS = {
  ...
  debugger: {
    ...
    models: [
      ...
      { id: 'gemini-2.5-pro', label: 'Gemini 2.5 Pro', provider: 'Gemini' },
      { id: 'gemini-1.5-flash', label: 'Gemini 1.5 Flash', provider: 'Gemini' },
      { id: 'anthropic/claude-3.5-haiku', label: 'Claude 3.5 Haiku (text-only)', provider: 'OpenRouter' },
      { id: 'anthropic/claude-3.7-sonnet', label: 'Claude 3.7 Sonnet (text-only)', provider: 'OpenRouter' },
    ],
    defaultModel: 'gemini-2.5-flash',
  },
  multimodal: {
